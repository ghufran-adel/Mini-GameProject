...
// let userPick;
// let userTotal = 0 + dealerPick;  //user card + dealercard
...
//     else 
//     {
//         console.log("You lost with a total of: " + userTotal);
//     }
// }
...
// {
//     userPick = getPick();  
//     //userTotal = userTotal + Number(userPick);
//     userTotal = getUserTotal(userPick);
//     console.log("Total: " + userTotal);
//    // continuePick = (userTotal < winTotal);
...
// Retrieve the selected number from the dropdown
